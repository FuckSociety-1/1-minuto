        ...
        <main className="flex-1 pt-32 pb-16 flex items-center justify-center">
          <div className="max-w-2xl mx-auto text-center px-8">
            ...
            <p className="font-paragraph text-xl text-soft-white/80 mb-8">
              Tu contenido ha sido enviado exitosamente. Será revisado y publicado pronto.
            </p>
            <Button
              onClick={() => navigate('/')}
        ...
        <div className="max-w-[100rem] mx-auto px-8">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="font-heading text-6xl text-soft-white mb-4">Subir Contenido Gratis</h1>
              <p className="font-paragraph text-xl text-soft-white/80">
                ¡Felicidades! Tu pago ha sido procesado. Ahora puedes subir tu contenido.
              </p>
            </div>

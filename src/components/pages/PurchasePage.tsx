            ...
            <div className="space-y-8 bg-soft-white/5 border border-soft-white/10 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                ...
                <Input
                  ...
                  className="bg-background border-soft-white/30 text-soft-white font-paragraph file:mr-2 file:py-2 file:px-2 file:rounded-lg file:border-0 file:bg-primary file:text-primary-foreground file:font-paragraph file:text-sm hover:file:bg-primary/90"
                />
                {contentFile && (
